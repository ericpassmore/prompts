...
- Deliver a SvelteKit frontend that consumes shared contracts and utilities.
...
- Implement frontend UI components in `packages/frontend/src/lib/components` and route composition in `packages/frontend/src/routes`.
...
- Replacing framework-specific conventions inside Express or SvelteKit internals.
